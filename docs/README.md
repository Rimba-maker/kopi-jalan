...
> Semua path kode dan aset di bawah ini dihitung dari root repository.
...
- [Brief halaman](../.impeccable/surfaces/src-pages-index-astro.md): keputusan khusus landing page. Tangkapan layar tinjauan: [desktop](../.impeccable/review/desktop.png) dan [mobile](../.impeccable/review/mobile.png).
- [Arsip brief awal](archive/README.md): status materi sumber. PRD `docs/archive/211-kedai-kopi-keliling-mobile-PRD.md` hanya ada secara lokal dan diabaikan Git; detail yang belum diimplementasikan atau diverifikasi bukan fakta situs.
